...
(from {order_amount} to {real_amount}) from Trades""")
    ...
    def handle_trade(self, trade: Trade) -> bool:
        ...
        if should_sell.sell_flag:
            ...
            return True
        logger.info('%s Found no sell signals for whitelisted currencies. Trying again..',trade.pair)
        return False
    ...
    def execute_sell(self, trade: Trade, limit: float, sell_reason: SellType) -> None:
        ...
        amount, quaselltrade = self.exchange.symbol_amount_prec_str(trade.pair, trade.amount)
        ...
        if order_id is not None:
            ...
            print('execute_sell ')
            print(trade.pair, limit, current_rate, trade.sell_reason, profit_trade)
